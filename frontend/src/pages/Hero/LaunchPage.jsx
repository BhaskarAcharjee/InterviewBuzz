...
import "../../assets/css/landingpage-external.css";
    ...
    <>
          ...
          <div class="container">
            <div class="row">
              <div class="offset-xl-3 col-xl-6 offset-lg-2 col-lg-8 col-md-12 col-sm-12">
                ...
                <button class="gradient-button" onClick={handleGetStarted}>
                  Get Started
                </button>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                <a href="#" class="mini-box">
                  <i>
                    <img src={work_process_item_1} alt="" />
                  </i>
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
              ...
              <div class="contact-text">
                ...
                <p>
                  You are NOT allowed to re-distribute Interview Buzz template
                  on any template collection websites. Thank you.
                </p>
              </div>
            </div>
            {/* <!-- ***** Contact Text End ***** --> */}
      ...
      <footer>
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-12">
              <p class="copyright">Copyright &copy; 2024 Interview Buzz</p>
            </div>
          </div>
        </div>
      </footer>
